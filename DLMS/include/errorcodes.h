...
typedef enum
{
    ...
    //////
    DLMS_ERROR_CODE_CONFORMANCE_LN_BIT_MISSING,
    DLMS_ERROR_CODE_DEDICATED_KEY_WITHOUT_CHIPERING,
    DLMS_ERROR_CODE_DLMS_VER_TOO_LOW,
    DLMS_ERROR_CODE_PDU_SIZE_TO_LOW,
} DLMS_ERROR_CODE;
